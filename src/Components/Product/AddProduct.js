...
class AddProduct extends Component {
  ...
  addProductFormSubmit = (e) =>{
    ...
    let product = {
        ...
        stock:10,
        image_1: "https://pbs.twimg.com/media/EhBF69tU8AA30rM?format=jpg&name=small",
        image_2: "https://pbs.twimg.com/media/EhBF69tU8AA30rM?format=jpg&name=small",
    ...
    return(
        ...
        <br/><br/>
              ...
              <Box id="addProductDiv">
                  <Button id="addProductBtn" type="submit"  onClick={this.addProductFormSubmit}  >Add Product</Button>
              </Box>
